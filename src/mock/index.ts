...
export const mockProposals: ProposalSummary[] = [
  ...
  {
    id: "pr2",
    title: "E-Learning Engagement Analytics",
...
export const mockStudentProjects: StudentProject[] = [
  {
    ...
    supervisorNotes:
      "التقدم ممتاز في المرحلة الأولى. يرجى التركيز على تحسين واجهة المستخدم وإضافة المزيد من الاختبارات.",
...
export const mockRequests: RequestItem[] = [
  {
    ...
    description:
      "أطلب الإشراف على مشروع تطوير نموذج ذكي لتحليل البيانات الطبية",
    status: "pending",
    priority: "high",
...
export const mockSchedules: ScheduleItem[] = [
  {
    id: "sc1",
    title: "اجتماع متابعة أسبوعي",
    type: "meeting",
    groupId: "g1",
    projectId: "1",
    supervisorId: "u2",
    attendees: ["u1", "u2"],
    start: "2024-01-27T10:00:00Z",
    end: "2024-01-27T10:30:00Z",
    location: "غرفة الاجتماعات 3",
    createdAt: "2024-01-20",
    updatedAt: "2024-01-22",
  },
];
