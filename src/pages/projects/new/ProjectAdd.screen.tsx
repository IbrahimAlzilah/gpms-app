...
import { useProjectAdd } from './ProjectAdd.hook'
import { CreateProjectInput } from '../schema'

const ProjectAddScreen: React.FC = () => {
    const navigate = useNavigate()
    const { createProject, isLoading, error } = useProjectAdd()
    const [formData] = useState<Partial<CreateProjectInput>>({})
    ...
    return (
        <div className="space-y-6">
            <Card>
                <CardHeader>
                    <h1 className="text-xl font-bold text-gray-900">إضافة مشروع جديد</h1>
                </CardHeader>
                <CardContent>
