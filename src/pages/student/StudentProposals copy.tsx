...
import { SearchBar, FilterDropdown, FilterBar } from '../../components/ui/Filter'
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3 rtl:space-x-reverse">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">{t('navigation.proposals')}</h1>
        ...
        <CardContent>
          ...
          <div className="space-y-4">
            ...
            <FilterBar>
              ...
              >
                <option value="submittedDate">تاريخ الإرسال</option>
