...
import { useUserEdit } from './UserEdit.hook'
...
const UserEditScreen: React.FC = () => {
  ...
  const { user: userData, updateUser, isLoading, error } = useUserEdit(id || '')
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <h1 className="text-xl font-bold text-gray-900">تعديل المستخدم</h1>
        </CardHeader>
        <CardContent>
